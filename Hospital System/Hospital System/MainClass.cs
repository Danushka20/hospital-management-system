...
namespace Hospital_System
{
    class MainClass
    {
        ...
        public static readonly string con_string = @"Data Source=DESKTOP-G1JFPHN\SQLEXPRESS;Initial Catalog=hospitalsystem;Integrated Security=True";
        ...
        public static void BlurBackground(Form Model)
        {
            ...
            using (Model)
            {
                ...
                Backgroung.Size = Admin.Instance.Size;
                Backgroung.Location = Admin.Instance.Location;
